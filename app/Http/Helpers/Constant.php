...
{
$price = $product->min_price; // GST Included Price
...
{
    $price = $product->max_price; // GST Included Price
...
{
return $variation->price; // GST Included Price
}
}
...
{
$finalPrice = $variation->price; // GST Included
$tax = 0;
...
foreach ($product->taxes as $product_tax) {
    ...
    if ($product_tax->tax_type == 'percent') {
        ...
        $tax += $finalPrice -
            ($finalPrice / (1 + ($product_tax->tax_value / 100)));
