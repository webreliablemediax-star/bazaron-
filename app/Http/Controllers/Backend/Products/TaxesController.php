...
class TaxesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view(
            'backend.pages.products.taxes.index',
            compact(
                'taxes',
                'searchKey',
                'is_published'
    ...
    public function store(Request $request)
    {
        ...
        flash(
            localize('Tax has been inserted successfully')
        )->success();
    ...
    public function edit($id)
    {
        ...
        return view(
            'backend.pages.products.taxes.edit',
            compact('tax')
        );
    }
    ...
    public function update(Request $request)
    {
        ...
        flash(
            localize('Tax has been updated successfully')
        )->success();
    ...
    public function delete($id)
    {
        ...
        flash(
            localize('Tax has been deleted successfully')
        )->success();
