...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private const MAP = [
        ...
        'application/vnd.bazaron.ebook' => ['azw'],
        'application/vnd.bazaron.mobi8-ebook' => ['azw3', 'kfx'],
    ...
    private const REVERSE_MAP = [
        ...
        'azw' => ['application/vnd.bazaron.ebook'],
        'azw3' => ['application/vnd.bazaron.mobi8-ebook', 'application/x-mobi8-ebook'],
        ...
        'kfx' => ['application/vnd.bazaron.mobi8-ebook', 'application/x-mobi8-ebook'],
