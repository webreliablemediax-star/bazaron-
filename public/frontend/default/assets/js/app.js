...
// ALL CATEGORIES – CLICK TOGGLE (FINAL FINAL)
...
$(document).on('click', '.close-sidebar', function () {
    $('.categories-sidebar').removeClass('active');
});




// sidebar ke andar click pe band na ho
$(document).on('click', '.categories-sidebar', function (e) {
    e.stopPropagation();
});
...
// ===============================
// DIRECT ADD TO CART (GLOBAL)
// ===============================
function directAddToCartFormSubmit(el) {
    let form = el.closest('form');

    $.ajax({
        url: "/add-to-cart", // 🔥 CORRECT ROUTE
        type: "POST",
        data: $(form).serialize(),
        headers: {
...
// // Product detail page - Add to Cart (single popup fix)
// $(document).off('submit', '.add-to-cart-form').on('submit', '.add-to-cart-form', function (e) {

//     // already checked? allow submit
//     if (window.pincodeChecked === true) {
//         return true;
//     }

//     e.preventDefault(); // submit rok do

//     // popup ek hi baar aaye
//     if (!window.pincodePopupShown) {
//         window.pincodePopupShown = true;

//         toastr.warning('Please check your delivery pincode before adding to cart.');

//         // thoda delay ke baad submit allow
//         let form = this;
//         setTimeout(function () {
//             window.pincodeChecked = true;
//             window.pincodePopupShown = false;
//             form.submit();
//         }, 1200);
//     }
// });
