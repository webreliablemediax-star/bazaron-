...
//js file k andr script tag use nhi hota...
    
document.addEventListener("DOMContentLoaded", function () {

    console.log("HAMBURGER JS LOADED");

    const allBtn = document.querySelector(".nav-left a");
    const megaMenu = document.querySelector(".nav-left .categories-sidebar");

    console.log(allBtn, megaMenu);

    if (!allBtn || !megaMenu) return;
    ...
    document.addEventListener("click", function (e) {
        if (!megaMenu.contains(e.target) && !allBtn.contains(e.target)) {
