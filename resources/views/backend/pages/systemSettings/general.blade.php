...
<div class="card mb-4" id="section-6">
    <div class="card-body">
        ...
        <div class="mb-3">
    <label class="form-label">{{ localize('Vendor Register Banner') }}</label>

    <input type="hidden" name="types[]" value="vendor_register_banner">

    <div class="tt-image-drop rounded">
        <span class="fw-semibold">{{ localize('Choose Vendor Register Banner') }}</span>
        ...
        <div class="tt-product-thumb show-selected-files mt-3">
            <div class="avatar avatar-xl cursor-pointer choose-media"
                ...
                <input type="hidden" name="vendor_register_banner"
                       value="{{ getSetting('vendor_register_banner') }}">
