                                    ...
                                    <tbody>
                                        @foreach ($variations as $key => $variation)
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach ($variation->categories as $cat)
                        ...
                        <form action="{{ route('admin.variations.store') }}" class="pb-650" method="POST">
                            ...
                            <div class="card mb-4" id="section-2">
                                <div class="card-body">
                                    ...
                                    <small class="text-muted">For example: 8GB RAM, 128GB Storage</small>
                                    @php
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if ($vendor)
                                            ...
                                            <input type="hidden" name="category_ids[]"
                                                value="{{ $vendor->product_categories }}">
                                            <p class="form-control bg-light">
                                                {{ \App\Models\Category::find($vendor->product_categories)->name ?? '' }}
                                            </p>
                                        @else
                                            <!-- ✅ ADMIN (unchanged) -->
