                            ...
                            <div class="card mb-4" id="section-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                                    ...
                                    <span>
                                        ...
                                        {{ $taxes->firstItem() }}-{{ $taxes->lastItem() }}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="tax_value" id="tax_value"
                                            placeholder="Example: 3,5,8,12,18,28" class="form-control" required>
                                    </div>
            ...
            $.post('{{ route('admin.taxes.updateStatus') }}', {
                ...
                function(data) {
                    if (data == 1) {
                        notifyMe(
                            'success',
                            '{{ localize('Status updated successfully') }}'
                        );
                    } else {
                        notifyMe(
                            'danger',
