...
<h5 class="mb-3">Add Promotional Banner 2</h5>

<div class="mb-3">
<input type="hidden" name="types[]" value="product_page_banner_2">

<label class="form-label">Promotional Banner 2</label>
...
<input type="hidden" name="product_page_banner_2"
value="{{ getSetting('product_page_banner_2') }}">
