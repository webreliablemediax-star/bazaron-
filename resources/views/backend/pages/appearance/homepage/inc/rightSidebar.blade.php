...
<li>
    <a href="{{ route('admin.appearance.homepage.fourthProductSection') }}"
        class="{{ areActiveRoutes(['admin.appearance.homepage.fourthProductSection']) }}">
        {{ localize(' Product Section') }}
    </a>
</li>