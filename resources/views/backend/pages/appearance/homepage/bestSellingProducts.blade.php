...
<div class="mb-3">
    ...
    <input type="hidden" name="types[]" value="best_selling_title">

    <input type="text"
        name="best_selling_title"
        class="form-control"
        placeholder="{{ localize('Best Selling Products') }}"
        value="{{ getSetting('best_selling_title') }}">
</div>
...
<div class="mb-3">
    ...
    <input type="hidden" name="types[]" value="best_selling_subtitle">

    <input type="text"
        name="best_selling_subtitle"
        class="form-control"
        value="{{ getSetting('best_selling_subtitle') }}">
</div>
