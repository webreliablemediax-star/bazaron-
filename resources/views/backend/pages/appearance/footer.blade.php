...
@section('contents')
                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    @php
                                        $quick_links =
                                            getSetting('quick_links') != null
                                                ? json_decode(getSetting('quick_links'))
                                                : [];
                                    @endphp
    ...
    <input type="hidden" name="types[]" value="footer_heading">

    <input type="text"
           name="footer_heading"
           class="form-control"
           value="{{ getSetting('footer_heading') }}"
           placeholder="Enter footer heading">
</div>
                                <div class="mb-3">
                                    <label class="form-label">Brand Directory</label>
                                    <input type="hidden" name="types[]" value="footer_brand_directory">

                                    <textarea name="footer_brand_directory" id="footer_brand_directory" class="editor form-control"
                                        data-buttons='[
        ["style", ["style"]],
