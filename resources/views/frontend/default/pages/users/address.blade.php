                ...
                <div class="col-xl-9">
                    <div class="address-book bg-white rounded p-5">
                        ...
                        <div class="d-flex justify-content-between">
                            <h4 class="mb-5" style="margin-top: -8px;">{{ localize('Address Book') }}</h4>
                            <a href="javascript:void(0);" onclick="addNewAddress()" class="fw-semibold" style="color: black;"><i
                                        ...
                                        <div class="address tt-address-info position-relative">
                                            ...
                                            <div class="tt-edit-address position-absolute">
                                                <a href="javascript:void(0);" onclick="editAddress({{ $address->id }})"
                                                    class="pe-1"
                                                    style="color: black;">{{ localize('Edit') }}</a>
