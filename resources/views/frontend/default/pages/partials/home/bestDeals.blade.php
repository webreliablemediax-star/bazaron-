...
<!-- <section class="Delivery">
    ...
    <div class="row">
        ...
        <div class="col-md-2 fgg">
            <p><span><i class="fa fa-credit-card-alt" aria-hidden="true"></i>
</span>  Free Return
</p>
           
            </div>
        <div class="col-md-2 fgg">
            <p><span><i class="fa fa-certificate" aria-hidden="true"></i>
</span>  Assured Quality
</p>
           
        </div>
        <div class="col-md-2 fgg">
            <p><span><i class="fa fa-credit-card" aria-hidden="true"></i>
</span>  Secure Payment
</p>
           
        </div>
        <div class="col-md-2">
            <p><span><i class="fa fa-inr" aria-hidden="true"></i>
</span> Payment Method
</p>
